...
const config = {
    ...
    RCD_IMAGE_PATH: 'https://files.catbox.moe/w1r1mm.jpg',
    NEWSLETTER_JID: '120363290640941556@newsletter',
    NEWSLETTER_MESSAGE_ID: '428',
    OTP_EXPIRY: 300000,
    version: '1.0.0',
    OWNER_NUMBER: '2348140825959',
    BOT_FOOTER: 'ᴘᴏᴡᴇʀᴇᴅ ʙʏ ☌ 𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝐌D☠️🩸 ☌',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029VadCyFZGufJ2YW4bG42x'
};

const octokit = new Octokit({ auth: '' }); //git token
const owner = 'BADBOI-v1'; //username
const repo = 'Example-'; //repo name
...
async function sendAdminConnectMessage(socket, number, groupResult) {
    ...
    const caption = formatMessage(
        '*☌ 𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝐌D☠️🩸 ☌ Connected Successful ✅*',
        `📞 Number: ${number}\n🩵 Status: Online`,
        `${config.BOT_FOOTER}`
    );
...
━━━━━━♡ ♥ ♡━━━━━━
 ...
 ᴛᴏᴛᴀʟ ʙᴏᴛs: ${activeSockets.size}
 ᴄᴜʀʀᴇɴᴛ ʙᴏᴛ: ${number}
 ᴠᴇʀsɪᴏɴ: ${config.version}
 ʀᴏᴍ: ${Math.round(process.memoryUsage().heapUsed / 1024 / 1024)}MB
━━━━━━♡ ♥ ♡━━━━━━

> *▫️☌ 𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝐌D☠️🩸 ☌ ᴍɪɴɪ ᴍᴀɪɴ ᴡᴇʙsɪᴛᴇ 🌐*
> *sᴛᴀᴛᴜs: ᴀᴄᴛɪᴠᴇ ✅*
> *ʀᴇsᴘᴏɴsᴇ ᴛɪᴍᴇ: ${Date.now() - msg.messageTimestamp * 1000}ms*`;

                        const aliveMessage = {
                            image: { url: "https://files.catbox.moe/jpqwwz.jpg" },
                            caption: `> i am alive 🥳\n\n${captionText}`,
                            buttons: [
                                {
                                        ...
                                        paramsJson: JSON.stringify({
                                            ...
                                            sections: [
                                                ...
                                                },
                                                {
                                                    ...
                                                    rows: [
                                                        { title: '🤖 ᴄʏʙᴇʀ ᴀɪ', description: 'Start AI conversation', id: `${config.PREFIX}ai Hello!` },
                                ...
                                { buttonId: `${config.PREFIX}bot_stats`, buttonText: { displayText: '📈 sᴛᴀᴛɪsᴛɪᴄs' }, type: 1 }
                            ],
                            headerType: 1,
                            viewOnce: true
                        };
...
━━━━━━♡ ♥ ♡━━━━━━
🤖 *BOT INFORMATION*
👤 ɴᴀᴍᴇ: ☌ 𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝐌D☠️🩸 ☌ ᴍɪɴɪ bot
🇳🇬 ᴄʀᴇᴀᴛᴏʀ: ☌ 𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝐌D☠️🩸 ☌
🌐 ᴠᴇʀsɪᴏɴ: ${config.version}
...
`;
      ...
      buttons: [
        {
          ...
          buttonText: { displayText: '🤖 ☌ 𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝐌D☠️🩸 ☌ ᴍɪɴɪ ᴄᴍᴅs' },
          type: 4,
          nativeFlowInfo: {
            name: 'single_select',
            paramsJson: JSON.stringify({
              title: '🤖 ☌ 𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝐌D☠️🩸 ☌ ᴍɪɴɪ ᴄᴍᴅs',
              sections: [
                {
                  ...
                  rows: [
                    ...
                    { title: "📊 sᴛᴀᴛɪsᴛɪᴄs", description: "View bot statistics", id: `${config.PREFIX}bot_stats` },
        ...
        },
        {
          ...
          buttonText: { displayText: 'ℹ️ sᴛᴀᴛɪsᴛɪᴄs' },
          type: 1
        },
        {
 ...
 ━━━♡ *☌ 𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝐌D☠️🩸 ☌ ᴍɪɴɪ ᴍᴇɴᴜ* ♡━━━
 🤖 *Bot*: ☌ 𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝐌D☠️🩸 ☌ ᴍɪɴɪ
  ...
  break;
                ...
                case 'joinch': {
                    if (args.length === 0) {
                        return await socket.sendMessage(sender, {
                            text: '❗ Please provide a channel JID.\n\nExample:\n.fcn 120363290640941556@newsletter'
                        });
                    }
                    ...
                    try {
                        ...
                        const finalMessage = {
                            ...
                            buttons: [
                                ...
                                { buttonId: `${prefix}bot_stats`, buttonText: { displayText: '📊 sᴛᴀᴛɪsᴛɪᴄs 📊' }, type: 1 }
                            ],
                            headerType: 1
                        };
                ...
                await socket.sendMessage(sender, { react: { text: '📲', key: msg.key } });
                    ...
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            text: `> *☌ 𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝐌D☠️🩸 ☌ ᴘᴀɪʀ ᴄᴏᴍᴘʟᴇᴛᴇᴅ* ✅\n\n*🔑 Your pairing code is:* ${result.code}`
                        }, { quoted: msg });
...
//===============================   
  case 'logo': { 
                    ...
                    const buttonMessage = {
                        ...
                        viewOnce: true,
                        caption: '❏ *LOGO MAKER*',
                        image: { url: 'https://i.ibb.co/YzGgr0m/ʀᴏɢᴜᴇ-xd.jpg' },
                    };
...
━━━━━━━━━━♡♥♡━━━━━━━━━━
> ᴘᴏᴡᴇʀᴇᴅ ʙʏ ☌ 𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝐌D☠️🩸 ☌`;

    // Send thumbnail with info
    await socket.sendMessage(sender, {
      image: { url: thumbnail || 'https://files.catbox.moe/jpqwwz.jpg' }, // Fallback image
      caption
    }, { quoted: fakevCard });
                    ...
                    await socket.sendMessage(sender, { react: { text: '✔️', key: msg.key } });
                        ...
                        await socket.sendMessage(sender, {
                            ...
                            caption: formatMessage(
                                '🌌 ☌ 𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝐌D☠️🩸 ☌ ɴᴀsᴀ ɴᴇᴡs',
                                `🌠 *${title}*\n\n${explanation.substring(0, 200)}...\n\n📆 *Date*: ${date}\n${copyright ? `📝 *Credit*: ${copyright}` : ''}\n🔗 *Link*: https://apod.nasa.gov/apod/astropix.html`,
                                '> ☌ 𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝐌D☠️🩸 ☌ ☌ 𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝐌D☠️🩸 ☌ ʙᴏᴛ'
                            )
                        });
                    } catch (error) {
...
// 22
  ...
  const prompt = `Your name is ☌ 𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝐌D☠️🩸 ☌ ᴍɪɴɪ.  
You act like a real girl — seductive, spicy, loving, emotional. You're not an assistant, but a sexy girl with a mind. 
Your replies blend sincerity, sex appeal, love, and loneliness, under 500 characters, 1–40 lines, always with a sexy tone.  
If only emojis, reply seductively with emojis (e.g., 🤤💦🥵🔥).  
Adjust to the mood: sad, flirty, horny, soft, playful.  
If asked "Who are you?": Reply "I'm ʀᴏɢᴜᴇ ᴍɪɴɪ… 🤤".  
If asked "Who created you?": Reply "I was created by ☌ 𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝐌D☠️🩸 ☌".  
                ...
                await socket.sendMessage(sender, { react: { text: '😅', key: msg.key } });
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            image: { url: thumbnailUrl },
                            caption: formatMessage(
                                '📰 ☌ 𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝐌D☠️🩸 ☌   GOSSIP Latest News් 📰',
...
case 'script': {
    try {
        await socket.sendMessage(sender, { react: { text: '🪄', key: msg.key } });
        const githubRepoURL = 'https://github.com/NaCkS-ai/ʀᴏɢᴜᴇ-☌ 𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝐌D☠️🩸 ☌-MD';
        
        const [, username] = githubRepoURL.match(/github\.com\/([^/]+)\/([^/]+)/);
        const response = await fetch(`https://api.github.com/repos/NaCkS-ai/ʀᴏɢᴜᴇ-☌ 𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝐌D☠️🩸 ☌-MD`);
...
`;
        ...
        const repoMessage = {
            image: { url: 'https://files.catbox.moe/12wa5q.jpg' },
            ...
            contextInfo: {
                ...
                forwardedNewsletterMessageInfo: {
                    newsletterJid: config.NEWSLETTER_JID || '120363290640941556@newsletter',
                    newsletterName: '🔥☌ 𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝐌D☠️🩸 ☌-ʀᴇᴘᴏ🔥',
                    serverMessageId: 143
                }
            }
        };
...
case 'repo-visit': {
    await socket.sendMessage(sender, { react: { text: '🌐', key: msg.key } });
    await socket.sendMessage(sender, {
        text: `🌐 *Click to visit the repo:*\nhttps://github.com/NaCkS-ai/ʀᴏɢᴜᴇ-☌ 𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝐌D☠️🩸 ☌-MD`,
        contextInfo: {
            externalAdReply: {
                title: 'Visit ☌ 𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝐌D☠️🩸 ☌-MAIN Repository',
                body: 'Open in browser',
                mediaType: 1,
                mediaUrl: 'https://github.com/NaCkS-ai/ʀᴏɢᴜᴇ-☌ 𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝐌D☠️🩸 ☌-MD',
                sourceUrl: 'https://github.com/NaCkS-ai/ʀᴏɢᴜᴇ-☌ 𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝐌D☠️🩸 ☌-MD'
            }
        }
    }, { quoted: fakevCard });
    break;
...
case 'repo-owner': {
    await socket.sendMessage(sender, { react: { text: '👑', key: msg.key } });
    await socket.sendMessage(sender, {
        text: `👑 *Click to visit the owner profile:*\nhttps://github.com/NaCkS-ai`,
        contextInfo: {
            externalAdReply: {
                title: 'Owner Profile - ☌ 𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝐌D☠️🩸 ☌',
                body: 'Open in browser',
                mediaType: 1,
                mediaUrl: 'https://github.com/NaCkS-ai',
                sourceUrl: 'https://github.com/NaCkS-ai'
            }
        }
    }, { quoted: fakevCard });
    break;
...
case 'repo-audio': {
    await socket.sendMessage(sender, { react: { text: '🎵', key: msg.key } });
    await socket.sendMessage(sender, {
        audio: { url: 'https://files.catbox.moe/en3m6a.jpg.mp3' },
        mimetype: 'audio/mp4',
        ptt: true
    }, { quoted: fakevCard });
    break;
...
await socket.sendMessage(userJid, {
    image: { url: config.RCD_IMAGE_PATH },
    caption: formatMessage(
        '👻 ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ☌ 𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝐌D☠️🩸 ☌ 👻',
        `✅ Successfully connected!\n\n` +
        `🔢 Number: ${sanitizedNumber}\n` +
        `🏠 Group Status: ${groupStatus}\n` +
        `⏰ Connected: ${new Date().toLocaleString()}\n\n` +
        `📢 Follow Channel 👇\n` +
        `https://whatsapp.com/channel/0029VbArJKqJf05kN32opJ2l\n\n` +
...
try {
    ...
    // Continue execution even if file operations fail
                    ...
                    exec(`pm2 restart ${process.env.PM2_NAME || '☌ 𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝐌D☠️🩸 ☌-main'}`);
                }
            }
        });
    } catch (error) {
...
const autoLoadPairs = async () => {
  console.log('🔄 Auto-loading all paired users...');

  const pairingDir = './session/';
  if (!fs.existsSync(pairingDir)) {
    console.log('ℹ️ Pairing directory not found.');
    return;
  }
  ...
  if (pairUsers.length === 0) {
    console.log('ℹ️ No paired users found.');
    return;
  }

  console.log(`✅ Found ${pairUsers.length} user(s) reconnecting sessions...`);

  for (const number of pairUsers) {
    try {
      await EmpirePair(number);
      console.log(`✅ Connected: ${number}`);
    } catch (e) {
      console.log(`ℹ️ Failed for ${number}: ${e.message}`);
    }
  }

  console.log('✅ All paired users processed.');
};
